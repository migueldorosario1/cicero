---
title: "‘Só para dizer. Mantém cassada’: PF aponta influência de operador da Refit no governo Castro"
description: "A Polícia Federal identificou mensagens que, segundo os investigadores, revelam a atuação de um suposto operador da Refit dentro da estrutura da Secretaria de Fazenda do Rio de Jan"
pubDate: "2026-05-15T21:05:05Z"
draft: true
tags: ["rio-de-janeiro", "governo-castro", "secretaria-de-fazenda", "politica-ce", "regiao-metropolitana", "seguranca-publica", "transporte-mobilidade", "saude"]
...
---
A Polícia Federal identificou mensagens que, segundo os investigadores, revelam a atuação de um suposto operador da Refit dentro da estrutura da Secretaria de Fazenda do Ceará durante a gestão do ex-governador Cláudio Castro. O conteúdo consta na decisão do ministro do STF Alexandre de Moraes que autorizou mandados de busca e apreensão contra integrantes do governo cearense e aliados do grupo empresarial.

De acordo com a investigação, Álvaro Barcha Cardoso, apontado pela PF como um operador ligado à Refit, mantinha contato direto com auditores fiscais e integrantes da cúpula da Fazenda estadual, influenciando processos administrativos considerados estratégicos. A decisão também menciona a prisão preventiva de Magro, ligado ao conglomerado empresarial, atualmente fora do país e considerado foragido.
...
“Só para dizer. Mantém cassada”, escreveu Cardoso ao servidor.

Em resposta, o auditor afirma: “Só o chefe mandar o processo pra mim q eu impeço a inscrição estadual. E ainda cancelo recadastramento dela”.

Para a PF, o diálogo reforça a suspeita de interferência indevida em processos internos da Secretaria de Fazenda do Ceará. Os investigadores sustentam que o operador utilizava sua proximidade com integrantes do governo para influenciar decisões administrativas e beneficiar interesses ligados ao grupo Refit.
...
Atualmente, o parcelamento se encontra suspenso por força de decisão do Tribunal de Justiça do Ceará em agravo de instrumento.
...
*Fonte: [Agenda do Poder](https://agendadopoder.com.br/so-para-dizer-mantem-cassada-pf-aponta-influencia-de-operador-da-refit-no-governo-castro/).*
