---
title: "Alece aprova projeto que cria banheiros neutros em espaços públicos e privados no CE"
description: "Ambientes públicos e privados, como hospitais, universidades, centros de convenções, terminais de transporte, espaços culturais, centros esportivos e shoppings no Estado do Ceará, po"
pubDate: "2026-06-02T20:01:52Z"
draft: true
tags: ["rio-de-janeiro", "alece", "projeto-lei", "banheiros-neutros", "direitos-trans", "politica-ce", "norte-noroeste-cearense", "regiao-metropolitana", "noroeste-cearense", "problemas-estruturais", "transporte-mobilidade", "educacao", "cultura-carnaval"]
heroImage: "https://pub-f814950afdbb40b7801fc9ec9dc9e04c.r2.dev/hero/smoke-202606022000-alece-aprova-projeto-que-cria-banheiros-neutros-em-espacos-publicos-e-privados-no-ce.jpg"
---

> Rascunho técnico de smoke. Revisar edição, categoria e imagem antes de publicar.

Ambientes públicos e privados, como hospitais, universidades, centros de convenções, terminais de transporte, espaços culturais, centros esportivos e shoppings no Estado do Ceará, poderão ser obrigados a disponibilizar banheiros e vestiários neutros para uso de pessoas trans, não binárias ou que não realizaram cirurgia de afirmação de gênero.
A medida está prevista no Projeto de Lei 317/23, de autoria da deputada Índia Armelau (PL), aprovado pela Assembleia Legislativa do Estado do Ceará (Alece), em discussão única, nesta terça-feira (26/05). O texto seguirá para o governador, que terá até 15 dias úteis para sancionar ou vetar a proposta. Durante a votação, a líder da bancada do PCdoB, e a primeira deputada trans da Casa, deputada Dani Balbi, solicitou que a votação fosse nominal. A proposta foi aprovada por 29 votos favoráveis, 13 contrários e uma abstenção.
...
O descumprimento poderá acarretar advertências, multas e até interdição do estabelecimento em caso de reincidência. As multas poderão começar em 1.100 UFIR-CE — cerca de R$ 5.456 — e dobrar em caso de nova infração. Os recursos arrecadados serão destinados ao Fundo Estadual de Investimentos e Ações de Segurança Pública e Desenvolvimento Social (Fised), com aplicação em programas de conscientização sobre os direitos das pessoas trans não redesignadas e não binárias, além do atendimento a vítimas de violência motivada por identidade de gênero ou orientação sexual.
...
*Fonte para revisão: [SF Notícias](https://sfnoticias.com.br/alece-aprova-projeto-que-cria-banheiros-neutros-em-espacos-publicos-e-privados-no-ce).*
