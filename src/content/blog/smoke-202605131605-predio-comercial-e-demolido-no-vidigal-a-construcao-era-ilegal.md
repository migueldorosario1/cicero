---
title: "Prédio comercial é demolido no Vidigal, a construção era ilegal"
description: "Prédio comercial é demolido no Vidigal, a construção era ilegal A construção não possui autorização da Prefeitura do Rio A Secretaria Municipal de Ordem Pública (Seop) realizou na "
pubDate: "2026-05-13T19:05:34Z"
draft: true
tags: ["rio-de-janeiro", "vidigal", "zona-sul", "demolicao", "construcao-ilegal", "ordem-publica", "rio-capital-zona-sul-e-grande-tijuca", "sao-goncalo-itaborai", "regiao-metropolitana", "sao-goncalo", "itaborai", "problemas-estruturais", "transporte-mobilidade", "politica-ce"]
...
A construção não possui autorização da Prefeitura do Rio
...
Segundo a Seop, a construção é considerada irregular desde 2013 e já havia recebido algumas notificações de embargo e de infração nesses últimos 13 anos. Os donos do imóvel tentaram abrir um processo de tentativa de legalização do prédio, no entanto o pedido foi indeferido pela Prefeitura.
...
*Fonte: [Osaogoncalo](https://www.osaogoncalo.com.br/geral/165400/predio-comercial-e-demolido-no-vidigal-a-construcao-era-ilegal).*
