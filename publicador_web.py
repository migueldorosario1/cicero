...
app = Flask(__name__)
app.secret_key = "super_secreto_cicero_wp"
...
<head>
    <meta charset="UTF-8">
    <title>Log In &lsaquo; Cícero — WordPress</title>
    <style>
...
<head>
    <meta charset="UTF-8">
    <title>Adicionar novo post &lsaquo; Cícero — WordPress</title>
    <style>
...
if __name__ == "__main__":
    print("Iniciando o Painel Administrativo do Cícero na porta 5000...")
