#!/usr/bin/env python3
"""Gera CSV com deputados estaduais eleitos do CE em 2022 a partir do TSE.

Fonte:
https://cdn.tse.jus.br/estatistica/sead/odsele/votacao_candidato_munzona/votacao_candidato_munzona_2022.zip

Saida padrao:
src/data/deputados_estaduais_eleitos_ce_2022.csv
"""
...
OUTPUT_PATH = PROJECT_ROOT / "src" / "data" / "deputados_estaduais_eleitos_ce_2022.csv"
JSON_OUTPUT_PATH = PROJECT_ROOT / "src" / "data" / "deputados_estaduais_eleitos_ce_2022.json"
...
def escrever_json(linhas: list[dict[str, Any]], output_path: Path) -> None:
    ...
    payload = {
        ...
        "criterio": "Deputados estaduais eleitos em 2022; percentual sobre total de votos válidos nominais para deputado estadual no CE.",
        "total": len(deputados),
        "deputados": deputados,
    }
