#!/usr/bin/env python3
"""Gera CSV e JSON com prefeitos eleitos no CE em 2024.

Fonte oficial:
https://cdn.tse.jus.br/estatistica/sead/odsele/votacao_candidato_munzona/votacao_candidato_munzona_2024.zip

Saidas padrao:
src/data/prefeitos_eleitos_ce_2024.csv
src/data/prefeitos_eleitos_ce_2024.json
"""
...
def escrever_json(linhas: list[dict[str, Any]], output_path: Path) -> None:
    ...
    payload = {
        "schemaVersion": "v1",
        "source": "TSE votacao_candidato_munzona_2024_CE.zip",
